...
fun MealsScreen(
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            ...
            // Use MaterialTheme.typography.h6 for consistency or custom style
            Text(
            ...
            SwipeRefresh(
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    // Text for Categories section with adjusted style
                    Text(
                        text = "Categories",
                    ...
                    // Text for Recipes section with adjusted style
                    Text(
                        text = "Recipes",
...
fun FloatingMoreRecipesButton(billingPurchaseHelper: InAppPurchasesHelper) {
    ...
    Button(
        ...
        // Uncomment if you want an icon with the button
        // Icon(Icons.Filled.More, contentDescription = "More Recipes", modifier = Modifier.size(ButtonDefaults.IconSize))
